...
<x-form.create title="Add New Editor">
    <form method="post" action="{{route("admin-dashboard.editors.store")}}" novalidate class=""
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="tel" name="phone"  value="{{old("phone")}}" class="form-control" pattern="^\+?[0-9-]+$">
            </div>

            <div class="col-md-6">
                <label for="">Whatsapp <span class="text-danger">*</span></label>
                <input type="tel" name="whatsapp" value="{{old("whatsapp")}}" class="form-control" pattern="^\+?[0-9-]+$">
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-6">
