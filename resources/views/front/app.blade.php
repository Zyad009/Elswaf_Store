...
<head>
    <title>{{$nameOfStore}} eCommerce HTML CSS Template</title>
    <meta charset="utf-8">
        ...
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <a class="navbar-brand text-success logo h1 align-self-center" href="{{route('home')}}">
                {{$nameOfStore}}
                            ...
                            @guest
                            <a type="button" class="btn btn-outline-dark navigation--button" href="{{route('login')}}">login</a>
                            <a type="button" class="btn btn-outline-dark navigation--button" href="{{route('register')}}">Register</a>
                            @endguest
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                ...
                <div class="navbar align-self-center d-flex">
                    ...
                    <a class="nav-icon position-relative text-decoration-none" href="{{route("messages")}}">
            ...
            <form action="{{route('logout')}}" method="post">
                @csrf
                <button type="submit" class="btn btn-outline-dark navigation--button" href="">Logout</button>
            </form>
             @endauth
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 pt-5">
                    <h2 class="h2 text-success border-bottom pb-3 border-light logo">{{$nameOfStore}}</h2>
