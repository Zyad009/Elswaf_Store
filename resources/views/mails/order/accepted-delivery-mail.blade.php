...
<head>
    <meta charset="UTF-8">
    <title>Order Accepted - Invoice</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <!-- Accepted order notification -->
        <div
            style="background-color: #d4edda; border: 1px solid #c3e6cb; color: #155724; padding: 15px; border-radius: 5px; margin-bottom: 20px;">
            <strong>✅ Good News:</strong> Your order has been <strong>accepted</strong> and is being prepared.
            <br>
            We will notify you again once it is out for delivery.
            <br>
            <strong>📢 Note:</strong> You will also receive an <strong>in-site notification</strong> once the order is
            on the
            way.
        </div>
